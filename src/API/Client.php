...
namespace alaaaq80\unifonic\src\API;
use alaaaq80\unifonic\src\API\Account\Account;
use alaaaq80\unifonic\src\API\Message\Message;
use alaaaq80\unifonic\src\API\Verify\Verify;
use alaaaq80\unifonic\src\API\Voice\Voice;
use alaaaq80\unifonic\src\API\Checker\Checker;
class Client
{
    /**
     * @var Message
